...
\begin{proof}
	...
	Покажем теперь, что размерность Хаусдорфа множества $E$ равна $1$.
	Т.к. для $j=1,2$ верно
	...
	По~\cite[Теорема 9.3]{falconer2003fractal} размерность Хаусдорфа $d$ множества $E$ является решением уравнения
	$ r_1^d+r_2^d=1$.
	Т.к. $r_j=1/2$, то
	$d=1.$
\end{proof}
...
также верно равенство $\dim_H \Omega^a_b = 1$.
