...
Возникает закономерный вопрос о свойствах,
которыми может обладать полуэберлейнов оператор.
Насколько <<далёк>> он может быть по своим свойствам от эберлейновых операторов?
...
Решение этой задачи не входит в цели данного диссертационного исследования;
она может быть взята в работу соискателем или кем-то из его коллег в дальнейшем.
