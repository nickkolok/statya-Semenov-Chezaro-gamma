...
по свойству~\ref{thm:alpha_x_leq_limsup_minus_liminf} следует, что $\alpha(x) \leq 2$.
...
\begin{proof}
	...
	\begin{multline}
		...
		.
	\end{multline}
	Повторив эти рассуждения $n$ раз, получаем требуемое.

	Докажем теперь левое неравенство.
	Зафиксируем $n$.
	Заметим, что
	\begin{equation}
