...
\begin{lemma}
	...
	Всякий мультипорождённый оператор $G_{\{B_k\}}$ В-регулярен.
\end{lemma}
...
\begin{proof}
	...
	Действительно,
	\begin{equation}
		G_{\{B_k\}} \mathbbm 1 = \mathbbm 1 \in ac_1
		,
	\end{equation}
	\begin{equation}
	...
	\end{equation}
	\begin{equation}
		G_{\{B_k\}} ac_0 = \{0\cdot \mathbbm1 \} \subset ac_0
		.
	\end{equation}
\end{proof}
...
\begin{hypothesis}
	Для мультипорождённого оператора $G_{\{B_k\}}$ имеет мест включение $\B (G_{\{B_k\}}) \subset \conv {\{B_k\}}$ конечно.
...
\begin{example}
	...
	\begin{equation}
		...
		.
	\end{equation}
	Следовательно, $B_1y = B_1Ay = B_1\mathbbm 1 = 1$, но $B_2y = B_2A\sigma_2 y = B_2(0\cdot \mathbbm 1) = 0$.
	...
	Действительно,
	\begin{equation}
		B_1 Hx  = (B_1 A) Hx = B_1 (AHx)  = B_1 ((B_1 x) \cdot \mathbbm 1) = B_1 x
	\end{equation}
	и
	\begin{equation}
		B_2 Hx  = (B_2 A\sigma_2) Hx = B_2 (A\sigma_2 Hx)  = B_2 ((B_2 x) \cdot \mathbbm 1) = B_2 x
		,
	\end{equation}
...
\begin{hypothesis}
	Пример~\ref{ex:multigen_invariant_interval} может быть обобщён на симплекс произвольной окнечной размерности
