...
\begin{remark}
	...
	Действительно,
	\begin{equation}
		B_1 (\sigma_2 H)x  = (B_1 A) (\sigma_2 H)x = B_1 (A(\sigma_2 H)x)  = B_1 ((B_2 x) \cdot \mathbbm 1) = B_2 x
	\end{equation}
	и
	\begin{equation}
		B_2 (\sigma_2 H)x  = (B_2 A\sigma_2) (\sigma_2 H)x = B_2 (A\sigma_4 Hx)  = B_2 ((B_1 x) \cdot \mathbbm 1) = B_1 x
		.
	\end{equation}
