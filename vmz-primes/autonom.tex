...
Доказывается, что существует бесконечно много таких последовательностей,
на которых нижний функционал Сачестона принимает значение 1,
при этом в нуль нижний функционал Сачестона ни на одной такой последовательности не обращается.
...
We prove that there are infinitely many sets of pairwise relative prime numbers
that lower Sucheston functional evaluates to 1 on the corresponding set of multiples
(and lower Sucheston functional never evaluates to 0 on a set of multiples).
...
{http://mi.mathnet.ru/rus/mz/v105/i3/p462}.
 — DOI: \href
{ https://doi.org/10.4213/mzm12298} {\nolinkurl
{10.4213/mzm12298}}.
%
