...
В параграфе~2 доказывается, что если объединение множеств всех простых делителей чисел из $\supp x$
конечно, то $x\in ac_0$.

В параграфе~3 изучаются такие $x\in \Omega$, что $\supp x$ не содержит чисел,
кратных элементам некоторого заданного множества.
Устанавливается, что одним из необходимых и достаточных условий обращения $q(x)$ в ноль
является наличие счётного множества попарно взаимно простых чисел
в дополнении объединения множеств всех простых делителей чисел из $\supp x$
до множества натуральных чисел.

В параграфе~4 изучается верхний функционал Сачестона на таких $x\in \Omega$ и устанавливается,
что $p(x)\in {[}0;1)$.
Приводятся необходимые и достаточные условия, при которых такой $x$ удовлетворяет равенству
$p(x)=0$ и, следовательно, принадлежит $ac_0$.
