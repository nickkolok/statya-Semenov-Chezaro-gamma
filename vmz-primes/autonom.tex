...
Перейдём теперь к изучению верхнего функционала Сачестона $q(\chi\mathscr{M}A)$.
...
\begin{theorem}
	...
	Тогда
	\begin{equation}
		q(\chi\mathscr{M}A) = \prod_{j=1}^\infty \left(1-\frac{1}{a_j}\right)
		.
	\end{equation}
\end{theorem}
...
\begin{proof}
	...
	\begin{equation}
		...
		q(\chi\mathscr{M}A) \leq \lim_{k\to \infty} \prod_{i=1}^k \frac{a_i-1}{a_i}
		=
