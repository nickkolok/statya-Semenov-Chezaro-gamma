...
Таким образом,
из лемм~\ref{lem:ac0_primes_infinity_mutually_prime_subset},~\ref{lem:ac0_primes_infinity_mutually_prime_subset_equiv_to_P_property}~и~\ref{lem:ac0_primes_q_psi_A_0_causes_P}
