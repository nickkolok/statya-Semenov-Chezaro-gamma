...
В работе \cite{Luxemburg} У. Люксембург ввел в рассмотрение стабилизатор пространства $ac_0$, обозначаемый ${\rm St}(ac_0)$,
...
Дальнейшему изучению стабилизатора пространства $ac_0$ посвящен  \S\ref{sec:W} данной работы.
...
Для любого $m\in \N$ найдем такое $k_0\in\N$, что $n_{2k_0}\geqslant m$ и положим
