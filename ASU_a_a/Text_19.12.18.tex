...
Банаховы пределы зарекомендовали себя как удобный и полезный инструмент в различных областях математики,
таких как некоммутативная геометрия и анализ~\cite{carey2006sledy},
теория операторов \cite{Sem_Sht} и гармонический анализ \cite{Ast_Sem, SU, U2}.
Применение банаховых пределов в этих и других областях подробно описано в недавнем обзоре \cite{semenov2020geomBL}.

Из определения сразу вытекает, что
$$\liminf_{n\to\infty}x_n \leqslant Bx \leqslant \limsup_{n\to\infty}x_n,$$
для всех $x\in \ell_\infty$ и что $\|B\|_{\ell_\infty^*}=1$.
...
В статье~\cite{lorentz1948contribution} Г.~Г.~Лоренц ввёл понятие почти сходящихся (к числу $a\in \mathbb R$) последовательностей,
т.е. таких последовательностей $x\in \ell_\infty$, что $Bx=a$ для любого банахова предела $B$.
...
Следующий критерий почти сходимости был доказан в работе~\cite{lorentz1948contribution}.
...
Результат Лоренца был усилен Л.~Сачестоном~\cite{sucheston1967banach} следующим образом.
...
В работе \cite{semenov2020dilation} показано, что это вложение строгое.
...
$$ \mes \, \{x\in \{0,1\}^\N: q(x)=0, \ p(x)=1\}=1.$$ Отсюда сразу вытекает утверждение \cite{connor1990almost} о том, что
...
\begin{proof}
Для любого $t\in[0,1]$, применяя теорему Сачестона \cite{sucheston1967banach} к числовой последовательности $f_n(t)$, получаем
...
Т.е. последовательность измеримых функций $Bg_k$ равномерно сходится к функции $F_B$. В силу~\cite[Теорема 4.2.2]{Natanson} $F_B$ также измерима.
\end{proof}
...
%
\bibitem{Mazur}
\emph{Mazur} \emph{S.} O metodach sumomalności // Ann. Soc. Polon. Math.
(Supplement). — 1929. — Str. 102–107.
%
\bibitem{banach2001theory_rus}
\emph{Банах} \emph{С.} Теория линейных операций. — Регуляр. и хаот.
динамика М, 2001.
%
\bibitem{carey2006sledy}
\emph{Кери} \emph{А. Л.}, \emph{Сукочев} \emph{Ф. А.} Следы Диксмье и
некоторые приложения в некоммутативной геометрии // Успехи математических
наук. — 2006. — Т. 61, 6 (372). — С. 45—110.
%
\bibitem{Sem_Sht}\emph{Семёнов} \emph{Е. М.}, \emph{Штейнберг} \emph{А. М.} Оценки норм
операторных блоков в банаховых решетках // Математический сборник. —
1985. — Т. 126, No 3. — С. 327—343.
%
\bibitem{Ast_Sem}
\emph{Асташкин} \emph{С. В.}, \emph{Семёнов} \emph{Е. М.} Константы
Лебега системы Уолша и банаховы пределы // Сибирский математический
журнал. — 2016. — Т. 57, No 3. — С. 512—526.
%
\bibitem{SU}
\emph{Семенов} \emph{Е. М.}, \emph{Усачев} \emph{А. С.} Коэффициенты
Фурье–Хаара и банаховы пределы // Доклады Академии наук. Т. 425. — 2009. —
С. 172—173.
%
\bibitem{U2}
\emph{Usachev} \emph{A.} On Fourier–Haar coefficients of the function from the
Marcinkiewicz space // Journal of Mathematical Analysis and Applications. —
2014. — Vol. 414, no. 1. — Pp. 110–124.
%
\bibitem{semenov2020geomBL}
\emph{Семёнов} \emph{Е. М.}, \emph{Сукочев} \emph{Ф. А.},
\emph{Усачев} \emph{А. С.} Геометрия банаховых пределов и их приложения //
Успехи математических наук. — 2020. — Т. 75, 4 (454). — С. 153—194.
%
\bibitem{lorentz1948contribution}
\emph{Lorentz} \emph{G. G.} A contribution to the theory of divergent
sequences // Acta Mathematica. — 1948. — Vol. 80, no. 1. — Pp. 167–190. — ISSN
0001-5962.
%
\bibitem{sucheston1967banach}
\emph{Sucheston} \emph{L.} Banach limits // Amer. Math. Monthly. — 1967. —
Vol. 74. — Pp. 308–311. — ISSN 0002-9890.%
\bibitem{Luxemburg}
\emph{Luxemburg} \emph{W. A. J.} Nonstandard hulls, generalized limits and
almost convergence // Analysis and geometry. — Bibliographisches Inst., Mannheim,
1992. — Pp. 19–45.
%
\bibitem{Alekhno}
\emph{Alekhno} \emph{E.} Superposition operator on the space of sequences
almost converging to zero // Cent. Eur. J. Math. — 2012. — Vol. 10, no. 2. —
Pp. 619–645. — ISSN 1895-1074. — DOI: {10.2478/s11533-011-0135-7}. —
URL: {http://dx.doi.org/10.2478/s11533-011-0135-7}.
%
\bibitem{SSU2}
\emph{Семёнов} \emph{Е. М.}, \emph{Сукочев} \emph{Ф. А.},
\emph{Усачев} \emph{А. С.} Геометрические свойства множества банаховых
пределов // Известия Российской академии наук. Серия математическая. —
2014. — Т. 78, No 3. — С. 177—204.
%
\bibitem{ASSU4}
Invariant Banach limits and their extreme points / E. Alekhno [et al.] // Studia
Mathematica. — 2018. — Vol. 242, no. 1. — Pp. 79–107.
%
\bibitem{SSUZ2}
Invariant Banach limits and applications to noncommutative geometry / E. Semenov
[и др.] // Pacific Journal of Mathematics. — 2020. — Т. 306, No 1. — С. 357—373.
%
\bibitem{semenov2020dilation}
Dilation invariant Banach limits / E. Semenov [и др.] // Indagationes
Mathematicae. — 2020. — Т. 31, No 5. — С. 885—892.
%
\bibitem{AvSU}\emph{Авдеев} \emph{Н. Н.}, \emph{Семёнов} \emph{Е. М.},
...
\emph{Connor} \emph{J.} Almost none of the sequences of 0’s and 1’s are almost
convergent // International Journal of Mathematics and Mathematical Sciences. —
1990. — Vol. 13, no. 4. — Pp. 775–777.
%
\bibitem{keller1992invariant}
\emph{Keller} \emph{G.}, \emph{Moore Jr} \emph{L.} Invariant means on the
group of integers // Analysis and geometry. — 1992. — Pp. 1–18.
%
\bibitem{klenke2013probability}
\emph{Klenke} \emph{A.} Probability theory: a comprehensive course. — Springer
...
С. 462—466.
%
\bibitem{Fekete}\emph{Fekete} \emph{M.} Über die {V}erteilung der {W}urzeln bei gewissen
algebraischen {G}leichungen mit ganzzahligen {K}oeffizienten // Math. Z. — 1923. —
Jg. 17, Nr. 1. — S. 228–249. — ISSN 0025-5874. — DOI:
{10.1007/BF01504345}.
%
\bibitem{polia1978zadachi}
\emph{Полиа} \emph{Г.}, \emph{Сеге} \emph{Г.} Задачи и теоремы из анализа.
Т. 1. — Наука. Гл. ред. физ.-мат. лит., 1978.
%
\bibitem{Edgar}
\emph{Edgar} \emph{G.} Measure, topology, and fractal geometry. — Springer
Science \& Business Media, 2007.
%
\bibitem{falconer1997techniques}
\emph{Falconer} \emph{K.} Techniques in fractal geometry. — John Wiley \&
Sons, Ltd., Chichester, 1997. — Pp. xviii+256. — ISBN 0-471-95724-0.
%
\bibitem{Eberlein}
\emph{Eberlein} \emph{W. F.} Banach-{H}ausdorff limits // Proc. Amer. Math.
Soc. — 1950. — Vol. 1. — Pp. 662–665. — ISSN 0002-9939.
%
\bibitem{SS_JFA}
\emph{Semenov} \emph{E. M.}, \emph{Sukochev} \emph{F. A.} Invariant
{B}anach limits and applications // J. Funct. Anal. — 2010. — Vol. 259, no. 6. —
Pp. 1517–1541. — ISSN 0022-1236. — DOI:
{10.1016/j.jfa.2010.05.011}. — URL:
{http://dx.doi.org/10.1016/j.jfa.2010.05.011}.
%
\bibitem{ASSU2}
Порядковые и геометрические свойства множества банаховых пределов /
Е. А. Алехно [и др.] // Алгебра и анализ. — 2016. — Т. 28, No 3. — С. 3—35.%
\bibitem{FT}
\emph{Fremlin} \emph{D. H.}, \emph{Talagrand} \emph{M.} A decomposition
theorem for additive set-functions, with applications to Pettis integrals and ergodic
means // Mathematische Zeitschrift. — 1979. — Vol. 168, no. 2. — Pp. 117–142.
%
\bibitem{Natanson}
\emph{Натансон} \emph{И. П.} Теория функций вещественной переменной. —
М.: Наука, 1974.
%
\bibitem{Mokobodzki}
\emph{Mokobodzki} \emph{G.} Ultrafiltres rapides sur N. Construction d’une
densité relative de deux potentiels comparables // Séminaire de Théorie du Potentiel,
dirigé par M. Brelot, G. Choquet et J. Deny : 1967/68, Exp. 12. — 1969. — P. 22.
%
\bibitem{Bjorklund}
\emph{Björklund} \emph{M.}, \emph{Hartnick} \emph{T.} Biharmonic functions
on groups and limit theorems for quasimorphisms along random walks // Geometry
\& Topology. — 2011. — Vol. 15, no. 1. — Pp. 123–143.
\end{thebibliography}
