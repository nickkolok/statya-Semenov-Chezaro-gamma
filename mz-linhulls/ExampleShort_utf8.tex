...
\begin{proof}
	...
	Пусть $x=(a-b)Sy+b\mathbb{I}$, $z=(a-b)(\mathbb{I}-Sy)+b\mathbb{I}$.
	Тогда $p(x)=p(z)=a$, $q(x)=q(z)=b$ и, следовательно, $x,z\in Y^a_b$.
	Кроме того, заметим, что
	\begin{equation}
		x+z = (a-b)Sy+b\mathbb{I} + (a-b)(\mathbb{I}-Sy)+b\mathbb{I}
		=
		(a-b)(Sy-Sy+\mathbb{I}) + 2 b\mathbb{I} = (a+b)\mathbb{I}
		,
	\end{equation}
...
\begin{proof}
	...
	$y=-aS(2M(1,0,1,0,1,0,1,0,...)-\mathbb{I})$,
	$z=-aS(2M(0,1,0,1,0,1,0,1,...)-\mathbb{I})$.
	...
	\begin{multline}
		...
		=
		\\=
		aS(2M(\mathbb{I})-\mathbb{I}) - aS(2M(1,0,1,0,1,0,...)-\mathbb{I}) - aS(2M(0,1,0,1,0,1,...)-\mathbb{I})
		=
		\\=
		aS(2M(\mathbb{I})-\mathbb{I}  -    2M(1,0,1,0,1,0,...)+\mathbb{I}  -    2M(0,1,0,1,0,1,...)+\mathbb{I})
		=
		\\=
		aS(2M(\mathbb{I}) - 2M(1,0,1,0,1,0,...) - 2M(0,1,0,1,0,1,...)+\mathbb{I}+\mathbb{I}-\mathbb{I})
		=
		\\=
		aS(2M(\mathbb{I}) - 2M(1,0,1,0,1,0,...) - 2M(0,1,0,1,0,1,...)+\mathbb{I})
		=
		aS\mathbb{I}
		=
		a\mathbb{I}
...
\begin{proof}
	...
	$C\cdot\mathbb{I}\in Y^a_b$; кроме того,
	\begin{equation}
		p(y) = k\cdot p(x) + C
		=
		%\\=
...
\begin{lemma}
	...
	Справедливо включение
	$\mathbb{I}\in \operatorname{Lin} X^a_b$.
\end{lemma}
...
\begin{proof}
	...
	и, следовательно,
	\begin{equation}
		\mathbb{I} \in \operatorname{Lin} Y^a_b \subset \operatorname{Lin} X^a_b
		.
	\end{equation}
\end{proof}
