...
\begin{itemize}
	...
	\item
		\(c_{00}\) — the space of sequences with finite support~\cite[Theorem 4]{alekhno2017order};
	\item
	...
	\item
		\(A_0 = \{ x\in\ell_\infty : \alpha(x) = 0\}\) (see below; for properties of this space, see Section~\ref{sec:noncomplementarity});
	\item
...
The distance from an element to a set as well as between two sets will be written as $\rho(\cdot, \cdot)$.
