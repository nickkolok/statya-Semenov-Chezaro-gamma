...
\newcommand{\lastnamerus}{Авдеев}
%\newcommand{\lastnameeng}{Avdeev}
\newcommand{\lastnameeng}{Hall}
\DeclareBibliographyCategory{byname}

\DeclareIndexNameFormat{byname}{% Test could be refined
  \ifboolexpr{
			not test {\ifdefstring{\lastnameeng}{#1}}
			%test {\ifdefstring{\lastnamerus}{#1}}
            %or not test {\ifdefstring{\lastnameeng}{#1}}
  }
